...
```{r, out.width='80%'}
Table_1 <- read.csv("NE_Table1.csv")

colnames(Table_1) <- c("Trip", "Classification")

flextable(Table_1, col_keys = c("Trip", "Classification")) %>%
  bold(part = "header") %>%
...
#       row.names = F,
#       align = rep('l',times=2),
#       caption = "Definitions for NM, SOV, and HOV trips") %>%
...
```{r, out.width='80%'}
Table_2 <- read.csv("NE_Table2.csv")

colnames(Table_2) <- c("Trip", "Classification")

flextable(Table_2, col_keys = c("Trip", "Classification")) %>%
  bold(part = "header") %>%
  set_caption(caption = "Table 2: Definitions for WAT and DAT trips") %>%
  align(align = "left", part = "all") %>%
  autofit()
...
#       row.names = F,
#       align = rep('l',times=2),
#       caption = "Definitions for WAT and DAT trips") %>%
#   kable_styling(latex_options = "HOLD_position",
#                 full_width = T) %>%
#   row_spec(0, bold=T) %>%
#   column_spec(1, width="0.5in") %>%
...
```{r, out.width='80%'}
Table_3 <- read.csv("NE_Table3.csv")

colnames(Table_3) <- c("Trip purpose", "Origin purpose", "Destination purpose")

flextable(Table_3, col_keys = c("Trip purpose", "Origin purpose", "Destination purpose")) %>%
  bold(part = "header") %>%
  set_caption(caption = "Table 3: Definitions for HBW, HBNW, and NHB trips") %>%
  align(align = "left", part = "all") %>%
  autofit()
...
#       row.names = F,
#       align = rep('l',times=3),
#       caption = "Definitions for HBW, HBNW, and NHB trips") %>%
#   kable_styling(latex_options = "HOLD_position",
#                 full_width = T) %>%
#   row_spec(0, bold=T) %>%
...
```{r, out.width='80%'}
Table_4 <- read.csv("NE_Table4.csv")

colnames(Table_4) <- c("Trip", "Origin TAZ", "Destination TAZ", "Trip Duration")

flextable(Table_4, col_keys = c("Trip", "Origin TAZ", "Destination TAZ", "Trip Duration")) %>%
  merge_v(j = c("Origin TAZ", "Destination TAZ", "Trip Duration")) %>%
  bold(part = "header") %>%
  set_caption(caption = "Table 4: Calculation methods for origin TAZ, destination TAZ, and trip durations by trip") %>%
  align(align = "left", part = "all") %>%
  hline(border = fp_border(color = "black")) %>%
...
#       row.names = F,
#       align = rep('l',times=4),
#       caption = "Calculation methods for origin TAZ, destination TAZ, and trip durations by trip") %>%
#   kable_styling(latex_options = "HOLD_position",
#                 full_width = T) %>%
#   row_spec(0, bold=T) %>%
#   column_spec(1, width="0.5in") %>%
...
```{r, out.width='80%', fig.cap="Data form for trip duration models", fig.pos='H', out.extra = '', eval=FALSE}
loc="C:/Users/rpg_f.FL3/OneDrive - Renaissance Planning Group/MAPC/Task4/Naive_Accessibility_Models/Naive_Modeling_Results/"
...
```{r, , out.width='80%', fig.cap="Data form for generalized cost models", fig.pos='H', out.extra = '', eval=FALSE}
...
```{r, out.width='80%'}
Table_5 <- read.csv("NE_Table5.csv")

colnames(Table_5) <- c("Trip", "Measure", "Purpose", "β0", "β1", "R2", "AIC")

flextable(Table_5, col_keys = c("Trip", "Measure", "Purpose", "β0", "β1", "R2", "AIC")) %>%
  bold(part = "header") %>%
  italic(j = c("β0", "β1", "R2", "AIC"), part = "header") %>%
  set_caption(caption = "Table 5: Exponential and logistic modeling results", style = ".modal-header") %>%
  align(align = "left", part = "all") %>%
  autofit()
# 
...
# 
# names(naive_models) = c("Trip", "Measure", "Purpose", "$\\bm{\\beta_0}$", "$\\bm{\\beta_1}$", "equation", "$\\bm{R^2}$", "$\\bm{AIC}$")
# 
...
#       row.names = F,
#       align = rep('l',times=7),
#       caption = "Exponential and logistic modeling results") %>%
#   kable_styling(latex_options = "HOLD_position",
#                 full_width = TRUE) %>%
#   row_spec(0, bold=T) %>%
