...
# Map
a <- tm_shape(zones_a) + tm_polygons(col = "Trips",
                                     palette = rpg_color_pal("rpg_rainbow")(9),
                                     n = 9,
                                     alpha=0.6,
                                     style = "pretty",
...
t <- tm_shape(zones_t) + tm_polygons(col = "Trips",
                                     palette = rpg_color_pal("rpg_rainbow")(9),
                                     n = 9,
                                     alpha=0.6,
                                     style = "pretty",
...
w <- tm_shape(zones_w) + tm_polygons(col = "Trips",
                                     palette = rpg_color_pal("rpg_rainbow")(9),
                                     n = 9,
                                     alpha=0.6,
                                     style = "pretty",
...
b <- tm_shape(zones_b) + tm_polygons(col = "Trips",
                                     palette = rpg_color_pal("rpg_rainbow")(9),
                                     n = 9,
                                     alpha=0.6, 
                                     style = "pretty",
...
# Map
a <- tm_shape(prods) + tm_polygons(col = "tnc_trips",
                                     palette = rpg_color_pal("rpg_rainbow")(9),
                                     n = 9,
                                     alpha=0.6,
                                     style = "pretty",
...
t <- tm_shape(attrs) + tm_polygons(col = "tnc_trips",
                                     palette = rpg_color_pal("rpg_rainbow")(9),
                                     n = 9,
                                     alpha=0.6,
                                     style = "pretty",
...
w <- tm_shape(prods) + tm_polygons(col = "pct",
                                     palette = rpg_color_pal("rpg_rainbow")(9),
                                     n = 9,
                                     alpha=0.6,
                                     style = "pretty",
...
b <- tm_shape(attrs) + tm_polygons(col = "pct",
                                     palette = rpg_color_pal("rpg_rainbow")(9),
                                     n = 9,
                                     alpha=0.6, 
                                     style = "pretty",
